...
public class MyCallsAdapter extends ArrayAdapter<com.sarm.recordai.Model> {

	private final Context context;
	private List<com.sarm.recordai.Model> list;

	public MyCallsAdapter(Context context, List<com.sarm.recordai.Model> list) {
