...
public class MainActivity extends Activity {
	...
	protected void onResume() {
		if (updateExternalStorageState() == Constants.MEDIA_MOUNTED) {
			final List<com.sarm.recordai.Model> listDir = FileHelper.listFiles(this);
			...
			final com.sarm.recordai.MyCallsAdapter adapter = new com.sarm.recordai.MyCallsAdapter(this, listDir);
			...
			adapter.sort(new Comparator<com.sarm.recordai.Model>() {
				public int compare(com.sarm.recordai.Model arg0, com.sarm.recordai.Model arg1) {
	...
	private void setSharedPreferences(boolean silentMode) {
		...
		Intent myIntent = new Intent(context, com.sarm.recordai.RecordService.class);
