...
public class RecordMyPhoneReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		Log.d(RecordConstants.TAG, "MyPhoneReciever phoneNumber "+phoneNumber);

		if (RecordActivity.updateExternalStorageState() == RecordConstants.MEDIA_MOUNTED) {
			try {
				...
				if (extraState != null) {
					if (extraState.equals(TelephonyManager.EXTRA_STATE_OFFHOOK)) {
						...
						myIntent.putExtra("commandType",
								RecordConstants.STATE_CALL_START);
						...
						Intent myIntent = new Intent(context,
								RecordService.class);
						myIntent.putExtra("commandType",
								RecordConstants.STATE_CALL_END);
						context.startService(myIntent);
					} else if (extraState
						...
						Intent myIntent = new Intent(context,
								RecordService.class);
						myIntent.putExtra("commandType",
								RecordConstants.STATE_INCOMING_NUMBER);
